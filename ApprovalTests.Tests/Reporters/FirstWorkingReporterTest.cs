...
namespace ApprovalTests.Tests.Reporters
{
	...
	public class FirstWorkingReporterTest
	{
		...
		{
			var ex = ExceptionUtilities.GetException(() => new ImageReporter().Report(null, "received.txt"));
			Assert.AreEqual("ImageReporter Could not find a Reporter for file received.txt", ex.Message);
		}
	}
}