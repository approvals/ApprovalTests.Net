...
public static class CombinationApprovals
{
    ...
    {
        VerifyAllCombinations((a, _, _, _, _, _, _, _, _) => processCall(a), "[{0}]", aList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
    }
    ...
    {
        VerifyAllCombinations((a, _, _, _, _, _, _, _, _) => processCall(a), "[{0}]", resultFormatter, aList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
    }

    public static void VerifyAllCombinations<A, B>(Func<A, B, object> processCall, IEnumerable<A> aList, IEnumerable<B> bList)
    {
        VerifyAllCombinations((a, b, _, _, _, _, _, _, _) => processCall(a, b), "[{0},{1}]", aList, bList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
    }
    ...
    {
        VerifyAllCombinations((a, b, _, _, _, _, _, _, _) => processCall(a, b), "[{0},{1}]", resultFormatter, aList, bList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
    }
    ...
    {
        VerifyAllCombinations((a, b, c, _, _, _, _, _, _) => processCall(a, b, c), "[{0},{1},{2}]", aList, bList, cList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
    }
    ...
    {
        VerifyAllCombinations((a, b, c, _, _, _, _, _, _) => processCall(a, b, c), "[{0},{1},{2}]", resultFormatter, aList, bList, cList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
    }
    ...
    {
        VerifyAllCombinations((a, b, c, d, _, _, _, _, _) => processCall(a, b, c, d), "[{0},{1},{2},{3}]", aList, bList, cList, dList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
    }
    ...
    {
        VerifyAllCombinations((a, b, c, d, _, _, _, _, _) => processCall(a, b, c, d), "[{0},{1},{2},{3}]", resultFormatter, aList, bList, cList, dList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
    }
    ...
    {
        VerifyAllCombinations((a, b, c, d, e, _, _, _, _) => processCall(a, b, c, d, e), "[{0},{1},{2},{3},{4}]", aList, bList, cList, dList, eList, EMPTY, EMPTY, EMPTY, EMPTY);
    }
    ...
    {
        VerifyAllCombinations((a, b, c, d, e, _, _, _, _) => processCall(a, b, c, d, e), "[{0},{1},{2},{3},{4}]", resultFormatter, aList, bList, cList, dList, eList, EMPTY, EMPTY, EMPTY, EMPTY);
    }
    ...
    {
        VerifyAllCombinations((a, b, c, d, e, f, _, _, _) => processCall(a, b, c, d, e, f), "[{0},{1},{2},{3},{4},{5}]", aList, bList, cList, dList, eList, fList, EMPTY, EMPTY, EMPTY);
    }
    ...
    {
        VerifyAllCombinations((a, b, c, d, e, f, _, _, _) => processCall(a, b, c, d, e, f), "[{0},{1},{2},{3},{4},{5}]", resultFormatter, aList, bList, cList, dList, eList, fList, EMPTY, EMPTY, EMPTY);
    }
    ...
    {
        VerifyAllCombinations((a, b, c, d, e, f, g, _, _) => processCall(a, b, c, d, e, f, g), "[{0},{1},{2},{3},{4},{5},{6}]", aList, bList, cList, dList, eList, fList, gList, EMPTY, EMPTY);
    }
    ...
    {
        VerifyAllCombinations((a, b, c, d, e, f, g, _, _) => processCall(a, b, c, d, e, f, g), "[{0},{1},{2},{3},{4},{5},{6}]", resultFormatter, aList, bList, cList, dList, eList, fList, gList, EMPTY, EMPTY);
    }
    ...
    {
        VerifyAllCombinations((a, b, c, d, e, f, g, h, _) => processCall(a, b, c, d, e, f, g, h), "[{0},{1},{2},{3},{4},{5},{6},{7}]", aList, bList, cList, dList, eList, fList, gList, hList, EMPTY);
    }
    ...
    {
        VerifyAllCombinations((a, b, c, d, e, f, g, h, _) => processCall(a, b, c, d, e, f, g, h), "[{0},{1},{2},{3},{4},{5},{6},{7}]", resultFormatter, aList, bList, cList, dList, eList, fList, gList, hList, EMPTY);
    }
    ...
    public static string GetApprovalString<A>(Func<A, object> processCall, string format, Func<object, string> resultFormatter,
        IEnumerable<A> aList)
    {
        return GetApprovalString((a, _, _, _, _, _, _, _, _) => processCall(a), format, resultFormatter, aList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
    }

    public static string GetApprovalString<A>(Func<A, object> processCall, IEnumerable<A> aList)
    {
        return GetApprovalString((a, _, _, _, _, _, _, _, _) => processCall(a), "[{0}]", result => result + string.Empty, aList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
    }
    ...
    {
        return GetApprovalString((a, b, _, _, _, _, _, _, _) => processCall(a, b), format, resultFormatter, aList, bList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
    }

    public static string GetApprovalString<A, B>(Func<A, B, object> processCall, IEnumerable<A> aList, IEnumerable<B> bList)
    {
        return GetApprovalString((a, b, _, _, _, _, _, _, _) => processCall(a, b), "[{0},{1}]", result => result + string.Empty, aList, bList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
    }
    ...
    public static string GetApprovalString<A, B, C>(Func<A, B, C, object> processCall, string format, Func<object, string> resultFormatter,
        ...
        IEnumerable<C> cList)
    {
        return GetApprovalString((a, b, c, _, _, _, _, _, _) => processCall(a, b, c), format, resultFormatter, aList, bList, cList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
    }
    ...
    {
        return GetApprovalString((a, b, c, _, _, _, _, _, _) => processCall(a, b, c), "[{0},{1},{2}]", result => result + string.Empty, aList, bList, cList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
    }
    ...
    {
        return GetApprovalString((a, b, c, d, _, _, _, _, _) => processCall(a, b, c, d), format, resultFormatter, aList, bList, cList, dList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
    }

    public static string GetApprovalString<A, B, C, D>(Func<A, B, C, D, object> processCall, IEnumerable<A> aList, IEnumerable<B> bList,
        IEnumerable<C> cList, IEnumerable<D> dList)
    {
        return GetApprovalString((a, b, c, d, _, _, _, _, _) => processCall(a, b, c, d), "[{0},{1},{2},{3}]", result => result + string.Empty, aList, bList, cList, dList, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
    }
    ...
    public static string GetApprovalString<A, B, C, D, E>(Func<A, B, C, D, E, object> processCall, string format, Func<object, string> resultFormatter,
        ...
        IEnumerable<E> eList)
    {
        return GetApprovalString((a, b, c, d, e, _, _, _, _) => processCall(a, b, c, d, e), format, resultFormatter, aList, bList, cList, dList, eList, EMPTY, EMPTY, EMPTY, EMPTY);
    }
    ...
    public static string GetApprovalString<A, B, C, D, E>(Func<A, B, C, D, E, object> processCall, IEnumerable<A> aList, IEnumerable<B> bList,
        ...
        IEnumerable<E> eList)
    {
        return GetApprovalString((a, b, c, d, e, _, _, _, _) => processCall(a, b, c, d, e), "[{0},{1},{2},{3},{4}]", result => result + string.Empty, aList, bList, cList, dList, eList, EMPTY, EMPTY, EMPTY, EMPTY);
    }
    ...
    {
        return GetApprovalString((a, b, c, d, e, f, _, _, _) => processCall(a, b, c, d, e, f), format, resultFormatter, aList, bList, cList, dList, eList, fList, EMPTY, EMPTY, EMPTY);
    }
    ...
    public static string GetApprovalString<A, B, C, D, E, F>(Func<A, B, C, D, E, F, object> processCall, IEnumerable<A> aList, IEnumerable<B> bList,
        ...
        IEnumerable<E> eList, IEnumerable<F> fList)
    {
        return GetApprovalString((a, b, c, d, e, f, _, _, _) => processCall(a, b, c, d, e, f), "[{0},{1},{2},{3},{4},{5}]", result => result + string.Empty, aList, bList, cList, dList, eList, fList, EMPTY, EMPTY, EMPTY);
    }
    ...
    public static string GetApprovalString<A, B, C, D, E, F, G>(Func<A, B, C, D, E, F, G, object> processCall, string format, Func<object, string> resultFormatter,
        ...
        IEnumerable<G> gList)
    {
        return GetApprovalString((a, b, c, d, e, f, g, _, _) => processCall(a, b, c, d, e, f, g), format, resultFormatter, aList, bList, cList, dList, eList, fList, gList, EMPTY, EMPTY);
    }
    ...
    public static string GetApprovalString<A, B, C, D, E, F, G>(Func<A, B, C, D, E, F, G, object> processCall, IEnumerable<A> aList, IEnumerable<B> bList,
        ...
        IEnumerable<G> gList)
    {
        return GetApprovalString((a, b, c, d, e, f, g, _, _) => processCall(a, b, c, d, e, f, g), "[{0},{1},{2},{3},{4},{5},{6}]", result => result + string.Empty, aList, bList, cList, dList, eList, fList, gList, EMPTY, EMPTY);
    }
    ...
    {
        return GetApprovalString((a, b, c, d, e, f, g, h, _) => processCall(a, b, c, d, e, f, g, h), format, resultFormatter, aList, bList, cList, dList, eList, fList, gList, hList, EMPTY);
    }
    ...
    public static string GetApprovalString<A, B, C, D, E, F, G, H>(Func<A, B, C, D, E, F, G, H, object> processCall, IEnumerable<A> aList, IEnumerable<B> bList,
        ...
        IEnumerable<G> gList, IEnumerable<H> hList)
    {
        return GetApprovalString((a, b, c, d, e, f, g, h, _) => processCall(a, b, c, d, e, f, g, h), "[{0},{1},{2},{3},{4},{5},{6},{7}]", result => result + string.Empty, aList, bList, cList, dList, eList, fList, gList, hList, EMPTY);
    }
