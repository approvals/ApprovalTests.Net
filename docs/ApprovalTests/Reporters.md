...
"zshrc"
```
<sup><a href='/src/ApprovalTests/Reporters/GenericDiffReporter.cs#L28-L350' title='File snippet `text_file_types` was extracted from'>snippet source</a> | <a href='#snippet-text_file_types' title='Navigate to start of snippet `text_file_types`'>anchor</a></sup>
<!-- endsnippet -->
...
".tiff"
```
<sup><a href='/src/ApprovalTests/Reporters/GenericDiffReporter.cs#L355-L363' title='File snippet `image_file_types` was extracted from'>snippet source</a> | <a href='#snippet-image_file_types' title='Navigate to start of snippet `image_file_types`'>anchor</a></sup>
<!-- endsnippet -->
